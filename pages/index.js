...
export default function Home() {
  return (
    ...
    <main className={styles.main}>
      ...
      <p className={styles.copyfirst}>I’m the design manager at WebstaurantStore, where I spend my time coordinating the development of our platform’s design systems, leading the accessibility charge, and helping my team grow individual and as a group.</p>

      <p className={styles.copysecond}>On the side, I’m a host on the show Thunder Nerds, a livestream and podcast where we interview people from all aspects of technology to find out their stories, and to share their life lessons with others. I also run Friends of Figma, Tampa Bay where I help connect Figma users in the area and around the world.</p>
      </section>
