...
export default function Home() {
  return (
    ...
    <Main>
      ...
      <Hero>
        Designer leading teams that are creating good experiences for e-commerce content management, and building accessible interfaces. I aim to make digital products usable for everyone.
      </Hero>

      <Copyfirst>I’m the design manager at <a className="link" href="https://www.webstaurantstore.com/careers/" target="_blank">WebstaurantStore</a>, where I spend my time coordinating the development of our platform’s design systems, leading the accessibility charge, and helping my team grow individually and as a group.</Copyfirst>

      <Copysecond>On the side, I’m a host on the show <a href="https://thundernerds.io" className="link" target="_blank">Thunder Nerds</a>, a livestream and podcast where we interview people from all aspects of technology to find out their stories, and to share their life lessons with others. I also run <a href="https://friends.figma.com/tampa-bay/" target="_blank" className="link">Friends of Figma, Tampa Bay</a> where I help connect Figma users in the area and around the world.</Copysecond>
      </Section>
      <Footer>
        <FooterTitle>Say Hello.</FooterTitle>
        <p>I’m a big believer in being kind to each other, and I want to pay it forward with what knowledge I have—share with others what others have shared with me, and help lift them higher. I think it’s not only important, but as a veteran in this industry I want to set an example for others, and help the next generation. If you have a question, or just want to talk send me a message using the method of your choice.</p>
        <FooterBorder></FooterBorder>
        <a href="mailto:ask@mrbrianhinton.com?subject=I want to say hi" target="_blank" className='msglinkfirst'>ask@mrbrianhinton.com</a>  <a href="https://twitter.com/mrbrianhinton?lang=en" target="_blank" className='msglink'>@mrbrianhinton</a>
      </Footer>  
    </Main>
    </div>
  )
